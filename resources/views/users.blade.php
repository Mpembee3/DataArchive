      ...
      <div class="card">
        <div class="card-body pt-3">
          ...
          <ul class="nav nav-tabs nav-tabs-bordered">
            ...
            <li class="nav-item">
              <button class="nav-link" data-bs-toggle="tab" data-bs-target="#user-edit">Edit User</button>
            </li>
                            ...
                            <table class="table table-borderless datatable">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td scope="row">
                                    <div class="d-flex">
                                    <a href="{{route('admin-edit-user',$user->id)}}" class="btn btn-primary me-2">Edit</a>
