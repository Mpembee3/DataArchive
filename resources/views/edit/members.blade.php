...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="col-xl-12">
      ...
      <h2 class="text-center mb-4">Edit Memmber</h2>
            ...
            <div class="d-flex justify-content-end mb-3">
                <form action="{{ route('delete-member',$member->id) }}" method="post">
                    ...
                    <form action="{{route('update-member',$member->id)}}" method="post">
                      @csrf
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input type="text" name="fname" class="form-control" id="fname" required value="{{ $member->fname }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input type="text" name="lname" class="form-control" id="lname" required value="{{ $member->lname}}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input type="email" name="email" class="form-control" id="email" required value="{{ $member->email }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input type="text" name="phone" class="form-control" id="phone" required value="{{ $member->phone }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input type="text" name="address" class="form-control" id="address" required value="{{ $member->address }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input type="date" name="birthdate" class="form-control" id="birthdate" min="1940-01-01" required value="{{ $member->birthdate }}">
                        </div>
                    </div>
...
<div class="modal fade" id="editUserModal" tabindex="-1" aria-labelledby="editUserModalLabel" aria-hidden="true">
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      Developed by <a href="https://bootstrapmade.com/">David Mbalike</a>
    </div>
  </footer><!-- End Footer -->
