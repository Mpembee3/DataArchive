      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">{{$user->member->lname}}</span>
        ...
        <div class="card-body pt-3">
          ...
          <div class="tab-pane fade show active profile-overview pt-3" id="user-overview">
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                        <div class="d-flex">
                        <a href="{{route('edit-marriage',$marriage->id)}}" class="btn btn-primary me-2">Edit</a>
                             <form action="{{route('delete-marriage',$marriage->id)}}" method="post">
                                @csrf
                                @method('DELETE')
            ...
            <div class="tab-pane fade profile-edit pt-3" id="user-create">
              ...
              <form action="{{ route('add-marriage') }}" method="post">
                @csrf
                  ...
                  <div class="col-md-8 col-lg-9">
                    <select name="husband" class="form-select" id="supervisor">
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-md-8 col-lg-9">
                              <input type="date" name="marriage_date" class="form-control" id="birthdate" min="1940-01-01" required value="{{ old('birthdate') }}">
                          </div>
                      </div>
