...
<head>
  ...
  <!-- Favicons -->
  <link href="{{asset('assets/img/ETMClogo.png')}}" rel="icon">
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="{{asset('assets/assets/img/ETMClogo.png')}}" alt="">
        <span class="d-none d-lg-block">ETMC-Ubungo</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{route('registration')}}">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="{{route('marriages')}}">
              <i class="bi bi-circle"></i><span>Mariages</span>
            </a>
          </li>
          <li>
...
<section class="section profile">
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                        <div class="d-flex">
                        <a href="{{route('edit-event',$event->id)}}" class="btn btn-primary me-2">Edit</a>
                ...
                @csrf
                      ...
                      <div class="row mb-3">
                         ...
                         <div class="col-md-8 col-lg-9">
                             <input type="text" name="title" class="form-control" id="lname" required value="{{ old('lname') }}">
                         </div>
                      </div>
                      <div class="row mb-3">
                         <label for="lname" class="col-md-4 col-lg-3 col-form-label">Description</label>
                         <div class="col-md-8 col-lg-9">
                             <input type="text" name="description" class="form-control" id="lname" required value="{{ old('lname') }}">
                         </div>
                      </div>
                      
                      <div class="row mb-3">
                          <label for="birthdate" class="col-md-4 col-lg-3 col-form-label">Start Date</label>
                          <div class="col-md-8 col-lg-9">
                              <input type="date" name="start_date" class="form-control" id="birthdate" min="1940-01-01" required value="{{ old('birthdate') }}">
                            </div>
                      </div>
                      <div class="row mb-3">
                          <label for="birthdate" class="col-md-4 col-lg-3 col-form-label">End Date</label>
                          <div class="col-md-8 col-lg-9">
                              <input type="date" name="end_date" class="form-control" id="birthdate" min="1940-01-01" required value="{{ old('birthdate') }}">
                          </div>
                      </div>
                      <div class="row mb-3">
                         <label for="lname" class="col-md-4 col-lg-3 col-form-label">Location</label>
                         <div class="col-md-8 col-lg-9">
                             <input type="text" name="location" class="form-control" id="lname" required value="{{ old('lname') }}">
                         </div>
                      </div>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>ETMC-Ubungo</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
      ...
      Developed by <a href="https://tz.linkedin.com/in/david-a-mbalike-14a634263">David Mbalike</a>
    </div>
  </footer><!-- End Footer -->
 ...
 <script src="{{asset('assets/vendor/apexcharts/apexcharts.min.js')}}"></script>
  ...
  <script src="{{asset('assets/vendor/chart.js/chart.umd.')}}"></script>
