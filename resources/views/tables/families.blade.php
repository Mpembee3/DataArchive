      ...
      <div class="card">
        <div class="card-body pt-3">
          ...
          <ul class="nav nav-tabs nav-tabs-bordered">
            ...
            <li class="nav-item">
              <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#user-overview">Families</button>
            </li>

            <li class="nav-item">
              <button class="nav-link" data-bs-toggle="tab" data-bs-target="#user-create">Add Family</button>
            </li>

            <li class="nav-item">
              <button class="nav-link" data-bs-toggle="tab" data-bs-target="#user-edit">Edit Family</button>
            </li>
          ...
          <div class="tab-pane fade show active profile-overview pt-3" id="user-overview">
              ...
              <section class="section dashboard">
                <div class="row">
                  ...
                  <h5 class="card-title">Families <span></span></h5>
            ...
            <div class="tab-pane fade profile-edit pt-3" id="user-create">
              ...
              <!-- Create Family Form -->
              <form action="{{ route('add-family') }}" method="post">
                @csrf
                  
                <div class="row mb-3">
    <label for="fname" class="col-md-4 col-lg-3 col-form-label">Family Name</label>
    <div class="col-md-8 col-lg-9">
        <input type="text" name="name" class="form-control" id="fname" required value="">
    </div>
</div>

<div class="row mb-3">
    <label for="supervisor" class="col-md-4 col-lg-3 col-form-label">Family Head</label>
    <div class="col-md-8 col-lg-9">
        <select name="family_head" class="form-select" id="supervisor">
            <option selected disabled>Family Head</option>
